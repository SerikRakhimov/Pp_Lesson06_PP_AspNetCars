...
namespace PP_AspNetCars.Controllers
{
    public class CarsController : Controller
    {
        private readonly PP_AspNetCarsContext _context;

        public CarsController(PP_AspNetCarsContext context)
        {
            _context = context;
        }
        ...
        {
            int cn = _context.Car.ToList().Count;
            ViewData["NumCars"] = cn;
        ...
        public async Task<IActionResult> CarsShow()
        {
            int cn = _context.Car.ToList().Count;
            ViewData["NumCars"] = cn;
            return View(await _context.Car.ToListAsync());
